# (附文档)Python+深度学习 双碳目标下绿色建筑碳排放预测模型

**技术栈**：Python、Flask、机器学习

### 系统简介

本系统是基于 Python 与 Flask 构建的双碳目标下绿色建筑碳排放预测平台，采用前后端分离架构，通过机器学习模型对建筑碳排放数据进行建模与预测。系统包含普通用户与管理员两类角色，覆盖数据导入、模型训练、碳排放预测、碳价分析与结果可视化等完整业务流程。
